...
3.1tips:   
github的个人主页是由jekyll生成的。[jekyll是一个由ruby驱动的静态页面生成工具](https://github.com/mojombo/jekyll#readme)。
jekyll使用[YAML](https://github.com/mojombo/jekyll/wiki/yaml-front-matter)和[Liquid模板](http://liquidmarkup.org/)扩展。
...
3.2了解了jekyll的点滴知识，我们就可以开始搭建个人博客了。  
...
4.如果觉得，学习jekyll很麻烦，使用[jekyllbootstrap](http://jekyllbootstrap.com/)来快速地建立一个可更换主题模板的博客是个不错的选择。  
